...
include('inc/header.php'); ?>
    ...
    <div class="row">
      ...
      <div class="col-md-4 orange-theme-color text-center">
        <h1 class="salient-feature text-center">Salient Features</h1>
      </div>
      <div class="col-md-4">
    ...
    <section>
      <div id="pricing-plan">
        ...
        <div id="pricing-plan" class="row mg-bot-50">
          <div class="col-md-3">
            <div class="orange-line orange-line-plan-l"></div>
          </div>
          <div class="col-md-6 orange-theme-color">
        ...
        <div class="container mg-bot-50">
            ...
            <div class="col-md-4 mb-3">
              <div class="card-school plan-card-css h-410">
                <div class="card-body">
                  ...
                  <h1 class="txt-center txt-color mt-4">Rs 79/-</h1>
                  ...
                  <ul class="fa-ul custom-list">
                    <li>
                      <span class="fa-li"><i class="fa fa-check"></i></span>User
                      Management Module (Free)
                    </li>
                    <li>
              ...
              <div class="card-school plan-card-css h-410">
                <div class="card-body">
                  <h3
                    class="choose-plan-top-bg d-flex align-items-center justify-content-center"
                  >
                    Time Table Creation Module
                  </h3>
                  <!-- <h3 class="plan-card-heading-2 mr-top-100">Time Table Creation
                    Module</h3> -->
                  <h1 class="txt-center txt-color mt-4">Rs 41/-</h1>
                  <p class="txt-center">per student</p>
                  <div class="row mr-bottom-10">
                    <div class="col-md-1"></div>
                    <div class="col-md-10 mr-top--40">
              ...
              <div class="card-school plan-card-css h-410">
                <div class="card-body">
                  <h3 class="choose-plan-top-bg">
                    Result/Report card Management
                  </h3>
                  <!-- <h3 class="plan-card-heading-2 mr-top-100">Result/Report card Management</h3> -->
                  <h1 class="txt-center txt-color mt-4">Rs 58/-</h1>
                  <p class="txt-center">per student</p>
                  <div class="row mr-bottom-10">
                    <div class="col-md-1"></div>
                    <div class="col-md-10 mr-top--40">
            ...
            <div class="col-md-4 mb-3">
              <div class="card-school plan-card-css h-410">
                <div class="card-body">
                  ...
                  <h1 class="txt-center txt-color mt-4">Rs 90/-</h1>
                  <p class="txt-center">per student</p>
                  <div class="row mr-bottom-10">
                    <div class="col-md-1"></div>
                    <div class="col-md-10 mr-top--40">
            ...
            <div class="col-md-4 mb-3">
              <div class="card-school plan-card-css h-410">
                <div class="card-body">
                  ...
                  <h1 class="txt-center txt-color mt-4">Rs 69/-</h1>
                  <p class="txt-center">per student</p>
                  <div class="row mr-bottom-10">
                    <div class="col-md-1"></div>
                    <div class="col-md-10 mr-top--40">
            ...
            <div class="col-md-4 mb-3">
              <div class="card-school plan-card-css h-410">
                <div class="card-body">
                  ...
                  <h1 class="txt-center txt-color mt-4">Rs 57/-</h1>
                  <p class="txt-center">per student</p>
                  <div class="row mr-bottom-10">
                    <div class="col-md-1"></div>
                    <div class="col-md-10 mr-top--40">
          ...
          <div class="row mb-5">
            ...
            <div class="col-md-4">
              <img
                style="height: 150px"
                src="assets/img/School/Group 641.png"
                alt=""
              />
